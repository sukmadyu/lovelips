...
class HomeView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            kontak.save()
	    subject= 'Pesan pada website lovelips dari {}'.format(kontak.nama)
...
class DetailAHPView(View):
	...
	alt=np.concatenate((alt, cruelty_free_arr), axis=1)
        ...
        return render(request,self.template_name,{'harga_a':int(harga_a),'harga_b':int(harga_b),'harga_c':int(harga_c),
						  ...
						  'cruelty_free_a':int(cruelty_free_a),'cruelty_free_b':int(cruelty_free_b),
						  'cruelty_free_c':int(cruelty_free_c),
						  ...
						  'bobot_cruelty_free_a':cruelty_free_arr_a,'bobot_cruelty_free_b':cruelty_free_arr_b,
						  'bobot_cruelty_free_c':cruelty_free_arr_c,
						  ...
						  'kri_m':kri_m,'kri_n':kri_n,'kri_o':kri_o,
						  'kri_p':kri_p,'kri_q':kri_q,'kri_r':kri_r,
						  'kri_s':kri_s,'kri_t':kri_t,                                                
						  'bobot_harga':kri_harga,'bobot_isi':kri_isi,'bobot_pao':kri_pao,
						  'bobot_time':kri_time,'bobot_cruelty_free':kri_cruelty_free,
